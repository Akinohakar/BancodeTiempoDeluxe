...
public class notificationsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNotificationsDB= FirebaseDatabase.getInstance().getReference().child("Users").child(mCurrentUser.getUid()).child("");
        mNotificationsDB.addChildEventListener(new ChildEventListener() {
            @Override
